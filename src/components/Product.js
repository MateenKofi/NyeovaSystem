    ...
    <div className='mt-40'>
      <section className="flex flex-col items-center">
        ...
        <section className="flex flex-col w-4/5 md:w-8/12 md:text-center">
          <p>
            Our workforce consists of SMEs that are designed to match your
            development vision. Our software engineers are at the front end of
            technology and possess the tools to build, release, and scale an app
            to your specific needs. We provide a wealth of consulting services
            to small and medium business, large enterprises as well as
